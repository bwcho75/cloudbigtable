...
/**
 * Example 3. Simple Bulk insert example
 * @author terrycho
 ...
 * $ mvn compile exec:java -Dexec.mainClass=com.terry.hbase.example.Example3 \ 
...
public class Example3 {
	...
	public static void main(String args[]) throws IOException{
		...
		System.out.println("total record :"+Example3.count);
