...
/**
 * Example 6. Bulk Input with Mutator.put(List <Put> ) 
 * @author terrycho
 ...
 * $ mvn compile exec:java -Dexec.mainClass=com.terry.hbase.example.Example6 \ 
...
public class Example6 {
	...
	public static void main(String args[]) throws IOException{
		...
		System.out.println("total record :"+Example6.count);
