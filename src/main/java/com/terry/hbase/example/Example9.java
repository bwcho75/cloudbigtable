...
/*
 *  Example 9. This is HBase scan with prefix filter + Pagenation example 
 ...
 *   -Dfilter.prefix=[row key prefix]
 *   -Dpage.startrow=[row key for start offset]
 */
...
public class Example9 {
	...
	public static void main(String args[]) throws IOException{
	    ...
	    String startRowKey = System.getProperty("page.startrow");
	    ...
	    scan.setFilter(new PageFilter(PAGE_SIZE));
	    ...
	    // set pre fetch size to PAGE SIZE
	    scan.setCacheBlocks(true);
	    scan.setCaching(PAGE_SIZE);
